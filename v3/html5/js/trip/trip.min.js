...
(function(e, t) {
    ...
    var n = function(n, r) {
        this.settings = t.extend({
            ...
            onTripEnd: t.noop,
            onTripStop: t.noop
        }, r), this.tripData = n, this.$tripBlock = null, this.$tripArrow = null, this.$overlay = null, this.$bar = null, this.$root = t("body, html"), this.tripIndex = this.settings.tripIndex, this.timer = null, this.progressing = !1, this.hasExpose = !1, this.CONSTANTS = {
            LEFT_ARROW: 37,
            UP_ARROW: 38,
            RIGHT_ARROW: 39,
            DOWN_ARROW: 40,
    ...
    n.prototype = {
        ...
        showExpose: function(e) {
            ...
            }, e.data("trip-old-css", t).css(n).addClass("trip-exposed"), this.$overlay.show()
        },
        hideExpose: function() {
            this.hasExpose = !1;
        ...
        showCurrentTrip: function(e) {
            this.timer && this.timer.stop(), this.hasExpose && this.hideExpose(), this.progressing && (this.hideProgressBar(), this.progressing = !1), this.checkTripData(e), this.setTripBlock(e), this.showTripBlock(e), e.expose && this.showExpose(e.sel)
        },
        doLastOperation: function() {
            return this.timer.stop(), this.settings.enableKeyBinding && this.unbindKeyEvents(), this.hideTripBlock(), this.hasExpose && this.hideExpose(), this.settings.backToTopWhenEnded && this.$root.animate({
                scrollTop: 0
            }, "slow"), this.tripIndex = this.settings.tripIndex, this.settings.onTripEnd(), !1
        },
        ...
        run: function() {
            ...
            this.showCurrentTrip(t), this.showProgressBar(n), this.progressing = !0, this.timer = new r(function() {
        ...
        checkTripData: function(e) {
            if (typeof e.sel == "undefined" || typeof e.content == "undefined") return this.console.warn("Your tripData is not valid in obj :" + e + "."), !1
        },
        setTripBlock: function(e) {
            ...
            switch (e.position) {
                case "e":
                    this.$tripArrow.addClass("e"), this.$tripBlock.css({
                        left: t.offset().left + n + u,
                        top: t.offset().top - (s - r) / 2
                    });
                    break;
                case "s":
                    this.$tripArrow.addClass("s"), this.$tripBlock.css({
                        left: t.offset().left + (n - i) / 2,
                        top: t.offset().top + r + o
                    });
                    break;
                case "w":
                    this.$tripArrow.addClass("w"), this.$tripBlock.css({
                        left: t.offset().left - (u + i),
                        top: t.offset().top - (s - r) / 2
                    });
                    break;
                case "n":
                default:
                    this.$tripArrow.addClass("n"), this.$tripBlock.css({
                        left: t.offset().left + (n - i) / 2,
                        top: t.offset().top - o - s
                    })
            }
        },
